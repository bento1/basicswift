...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.fetchCovidOverview(completionHandler: {
            [weak self] result in//이해 안가는 부분.
            guard let self = self else {return} //이해 안가는 부분.
            ...
            case let .success(result):
                ...
                self.configureChartView(covoidOverviewList: covidOverviewList)
    ...
    //이해안가는 함수
    func configureChartView(covoidOverviewList : [CovidOverview]){
        self.pieChartView.delegate = self
        let entries = covoidOverviewList.compactMap { [weak self] overview -> PieChartDataEntry? in
